...
import { User, Wrench, Shield, Users, ArrowRight, Building2, Mail, Phone, Briefcase, Award, Code } from 'lucide-react';
...
const LoginPage = ({ onLogin }) => {
    ...
    const handleSignUp = (e) => {
        ...
        console.log('Sign up data:', { role: selectedRole, ...signUpData });
        alert(`Account created successfully for ${selectedRole}! You can now login.`);
