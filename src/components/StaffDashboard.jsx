...
import { 
  ...
  FileText, UserCheck, Wrench, Eye, Search
} from 'lucide-react';

const StaffDashboard = ({ onLogout, tickets }) => {
  ...
  const staffProfile = {
    ...
    email: 'panda.debdatta@gmail.com',
    phone: '+91 5879412345',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-slate-600 text-sm">Welcome, {staffProfile.name}</p>
              </div>
            </div>
            <button
              onClick={onLogout}
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div>
              ...
              <p className="font-semibold text-slate-900">{staffProfile.id}</p>
            </div>
            <div>
              <p className="text-sm text-slate-500 mb-1">Type</p>
              <p className="font-semibold text-slate-900">{staffProfile.type}</p>
            </div>
            <div>
              <p className="text-sm text-slate-500 mb-1">Location</p>
              <p className="font-semibold text-slate-900">{staffProfile.location}</p>
            </div>
            <div>
              <p className="text-sm text-slate-500 mb-1">Shift</p>
              <p className="font-semibold text-slate-900">{staffProfile.shift}</p>
            </div>
          </div>
        </motion.div>
        ...
        <div className="flex items-center space-x-2 mb-8 bg-white p-2 rounded-xl shadow-sm">
          {['overview', 'analytics', 'activity', 'reports'].map((tab) => (
            <button
              key={tab}
