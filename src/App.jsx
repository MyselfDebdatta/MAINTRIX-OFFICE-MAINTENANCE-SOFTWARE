    ...
    const [tickets, setTickets] = useState([
        {
            ...
            status: 'Resolved',
            timeline: [
                { stage: 'Ticket Raised', completed: true, timestamp: '2026-02-10 09:30 AM' },
                { stage: 'Manager Approved', completed: true, timestamp: '2026-02-10 10:15 AM' },
                { stage: 'Technician Assigned', completed: true, timestamp: '2026-02-10 11:00 AM' },
                { stage: 'In Progress', completed: true, timestamp: '2026-02-10 02:30 PM' },
                { stage: 'Resolved', completed: true, timestamp: '2026-02-11 04:00 PM' }
            ],
            technicianId: 'TECH-001',
            technicianName: 'Soumyashri Mahapatra',
            messages: [
                { from: 'Manager', text: 'Ticket approved. Assigned to Soumyashri Mahapatra.', time: '10:15 AM' },
